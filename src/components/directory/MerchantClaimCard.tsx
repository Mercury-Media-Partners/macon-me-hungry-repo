...
export const MerchantClaimCard = () => {
  ...
  return (
    <div className="p-6 rounded-lg border border-primary/40 bg-gradient-to-br from-primary/10 via-card to-muted/40 shadow-lg flex flex-col justify-between relative overflow-hidden group hover:border-primary/70 transition-all duration-300">
      {/* Subtle Background Glow Accent */}
      <div className="absolute -top-12 -right-12 w-32 h-32 bg-primary/20 rounded-full blur-2xl pointer-events-none" />

      <div>
        {/* Badge */}
        <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-md text-[10px] font-bold uppercase tracking-widest bg-primary/20 text-primary border border-primary/30 mb-4">
          <ShieldCheck size={12} />
