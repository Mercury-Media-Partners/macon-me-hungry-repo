...
### 3. Professional Tier (`tier: "professional"`)
*   **Allowed**: All Free fields + website, socials, gallery_images (up to 5), events (up to 1 recurring weekly event), jobs (up to 2 active jobs), lat/lng.
*   **Prohibited**: video_url, cta_label, cta_url.

### 4. Headliner Tier (`tier: "headliner"`)
