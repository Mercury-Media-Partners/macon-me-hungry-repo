...
4. **Active Event Calendar:** Publishing rights for up to three (3) recurring weekly events on the platform’s main calendar and search filters.
5. **Interactive Map:** Integration of interactive geospatial map view (Google Maps / Leaflet) indicating exact lat/lng coordinates and directions.

---

### 3. FEES, BILLING & TERM
* **Subscription Fee:** **$29.00 USD per Month (Founder Grandfather Rate)** (or **$199.00 USD per Year** if paid annually).
* **Billing Cycle:** Billed automatically on the Effective Date and recurring monthly/annually thereafter to the payment method on file.
* **Term:** This Agreement is on a month-to-month (or year-to-year) basis, commencing on the Effective Date.
* **Termination:** Either party may cancel the subscription at any time. Cancellation will take effect at the end of the current billing cycle. No refunds will be provided for partial billing periods.
...
#### **ADVERTISER (BUSINESS DETAILS)**
Business Name: **FiNCA to FiLTER (Old Fourth Ward)**  
Authorized Signature: _____________________________________  
Name: __________________________________________________  
Title: ___________________________________________________  
Date: ___________________________________________________  
